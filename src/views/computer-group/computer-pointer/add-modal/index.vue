<template>
    ...
    >
        ...
        >
            ...
            <el-form-item label="YunPort" prop="agentPort">
                <el-input
...
const rules = reactive<FormRules>({
    ...
    host: [
        { required: true, message: '请输入Host', trigger: ['blur', 'change'] },
        { validator: Validator.HostValidator('请输入正确的host'), trigger: ['blur', 'change'] }
    ],
    port: [
        { required: true, message: '请输入port', trigger: ['blur', 'change'] },
        { validator: Validator.PortValidator('请输入正确的端口号'), trigger: ['blur', 'change'] }
    ]
})
