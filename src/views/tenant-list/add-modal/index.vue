<template>
    ...
    >
        ...
        >
            ...
            <el-form-item label="管理员" prop="adminUserId" v-if="renderSence === 'new'">
...
const rules = reactive<FormRules>({
    name: [{ required: true, message: '请输入租户名称', trigger: ['change', 'blur'] }],
    adminUserId: [{ required: true, message: '请选择管理员', trigger: ['change', 'blur'] }],
})
